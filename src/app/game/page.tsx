          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={startGame}
                className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full font-bold text-lg"
              >
                Start Game
              </motion.button>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={startGame}
                className="px-8 py-3 bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-full font-bold text-lg"
              >
                Play Again
              </motion.button>
            </motion.div>
